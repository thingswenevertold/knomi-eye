...
const SkinDef SKINS[] = {
    ...
    // Les skins des creatures issues d'une photo sont emis par le
    // generateur, dans l'ordre du registre — append-only, l'index etant
    // persiste en NVS sur la carte.
#include "../assets/photo_skins.inc"
};
